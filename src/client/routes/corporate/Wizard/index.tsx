...
import { ProductWizardContextProvider, productWizardInitialState } from './ProductWizardContext';
// import Wizard from '@/routes/corporate/Wizard';

import Step1 from './Step1';
import Step2 from './Step2';
import Step3 from './Step1';
import Step4 from './Step1';
import Header from './Components/Header';
import Add from './Add';
...
const Wizard = (props: WizardProps) => {
  ...
  // const { fileType, selectAllItemClasses, selectedCategories, selectedItemClasses, categories } = React.useContext(ProductWizardContext);
  ...
  return (
    <ProductWizardContextProvider value={productWizardInitialState}>
